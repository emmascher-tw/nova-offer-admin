// ── Offer Templates (migrated from src/schemas/templates.js) ──
...
const templateDefaults = {
  ...
  timing_rules: { start_date: '', end_date: '', day_of_week: [] },
...
// ── Seed Offers (with status + template_id) ──
